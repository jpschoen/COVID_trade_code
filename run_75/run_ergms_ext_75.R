...
load("mono_net_75.Rdata")
load("mono_cov_75.Rdata")
ncores = 8
...
stopImplicitCluster()
save.image("results/precovid_full_ergms_75.Rdata")
...
stopImplicitCluster()
save.image("results/postcovidl0_full_ergms_75.Rdata")
...
stopImplicitCluster()
save.image("results/postcovidl3_full_ergms_75.Rdata")
...
save.image("results/postcovidl6_full_ergms_75.Rdata")
